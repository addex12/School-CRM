...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Fix: Attach reply button event to telegram-chat-item reply buttons
    ...
    replyForm.onsubmit = async function(e) {
        ...
        if (!replyReceiverId.value || replyReceiverId.value == <?= (int)$userId ?>) {
            alert('Cannot reply to yourself.');
            return;
        }
