...
<head>
    <!--
        ...
        Twitter: https://twitter.com/eleganceict1
        GitHub: https://github.com/addex12
        Purpose: Manage Users page, visually outstanding, interactive, and fully responsive.
    -->
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?= htmlspecialchars($pageTitle) ?> - Admin Panel</title>
    <!-- Adugna Gizaw: Use only admin.css for all admin styling and layout -->
...
<body>
            ...
            <div class="adugna-form-grid">
                <div class="adugna-card">
                    <div class="users-header">
                        <h2>User List</h2>
                        <a href="add_users.php" class="adugna-btn adugna-blue">
                            <i class="fas fa-user-plus"></i> Add User
                        </a>
                    </div>
                    <input type="text" id="userSearch" class="adugna-search-bar" placeholder="Search users..." style="margin-bottom:1rem;">
    ...
    // Adugna Gizaw: Simple search filter for users table
