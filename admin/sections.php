                                    ...
                                    <?php foreach ($sections as $section): ?>
                                        <tr>
                                            ...
                                            <td class="section-actions">
                                                ...
                                                <form action="delete_section.php" method="post" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this section?');">
                                                    <input type="hidden" name="id" value="<?= $section['id'] ?>">
                                                    <button type="submit" title="Delete" style="background:none;border:none;padding:0;margin:0;color:#3498db;cursor:pointer;">
