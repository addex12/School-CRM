...
if (!empty($menuJson)) {
    ...
    if (json_last_error() !== JSON_ERROR_NONE) {
        ...
        $adminMenu = []; // Reset to empty array if JSON is invalid
    }
}
...
<head>
    ...
    <style>
        ...
        .admin-nav.vertical a:hover, .admin-nav.vertical a.active {
        ...
        <header class="admin-header">
            <div class="logo">
                <?php if (!empty($siteLogo)): ?>
                    <img src="../assets/images/<?= htmlspecialchars($siteLogo) ?>" alt="Site Logo" class="logo-img">
                <?php endif; ?>
