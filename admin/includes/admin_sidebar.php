...
body .admin-sidebar.collapsed + .admin-main {
    margin-left: 60px;
    width: calc(100% - 60px); /* Adjust width dynamically */
}
</style>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setSidebarCollapsed(collapsed) {
        if (collapsed) {
            ...
            if (main) {
                main.style.marginLeft = window.innerWidth <= 900 ? '60px' : '60px';
                main.style.width = `calc(100% - ${window.innerWidth <= 900 ? '60px' : '60px'})`;
            }
            ...
            if (main) {
                ...
                main.style.width = `calc(100% - ${window.innerWidth <= 900 ? '200px' : '240px'})`;
            }
    ...
    function adjustMainMargin() {
        if (window.innerWidth <= 600) {
            if (sidebar.classList.contains('open')) {
                ...
                main.style.width = `calc(100% - ${sidebar.offsetWidth}px)`;
            } else {
