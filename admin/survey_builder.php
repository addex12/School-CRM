    ...
    try {
        ...
        foreach ($_POST['questions'] as $index => $question) {
            ...
            $options = in_array($_POST['field_types'][$index], ['radio', 'checkbox', 'select']) 
                ? json_encode(array_filter(array_map('trim', explode(',', $_POST['options'][$index] ?? ''))))
                : null;
            ...
            $stmt->execute([
                ...
                'field_' . ($index+1),
                htmlspecialchars($_POST['placeholders'][$index] ?? ''),
                $options,
            ...
            <div class="content">
                ...
                <header class="builder-header">
                    ...
                    <div class="form-actions">
                        <button type="submit" form="survey-form" name="save_survey" class="btn btn-success">
                        ...
                        <div class="grid-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="ends_at" required
                                       value="<?= isset($survey['ends_at']) ? date('Y-m-d', strtotime($survey['ends_at'])) : date('Y-m-d', strtotime('+1 week')) ?>">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="switch-container">
                                    <label class="switch">
                                        ...
                                        <span class="switch-label">Anonymous Responses</span>
                                    </label>
                                </div>
                            </div>
                        </div>
