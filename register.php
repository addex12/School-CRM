...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        // Use email as username, and insert first_name and last_name
        $stmt = $pdo->prepare("INSERT INTO users (username, email, password, role_id, active, first_name, last_name) VALUES (?, ?, ?, ?, ?, ?, ?)");
        if ($stmt->execute([$email, $email, $hashed_password, $role_id, $active, $first_name, $last_name])) {
